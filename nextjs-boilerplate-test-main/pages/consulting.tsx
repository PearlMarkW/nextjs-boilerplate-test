        ...
        <div style={{ paddingTop: '60px' }}>
            ...
            <section className="flex flex-col lg:flex-row items-center justify-between p-8 h-128">
                ...
                <div className="lg:w-1/2 flex justify-center items-center">
                    <img src="/images/rugby.jpg" alt="Differentiation" className="w-auto h-auto max-w-full max-h-[600px]" />
                </div>
            </section>
            ...
            <section className="grid grid-cols-1 md:grid-cols-3 gap-8 p-8">
                <div className="text-center">
                    <img src="/images/woods.jpg" alt="Strategy" className="mx-auto mb-4 w-48 h-48 object-cover rounded-full" />
                ...
                <div className="text-center">
                    <img src="/images/analytics.jpg" alt="Analytics" className="mx-auto mb-4 w-48 h-48 object-cover rounded-full" />
                ...
                <div className="text-center">
                    <img src="/images/coding.jpg" alt="Implementation" className="mx-auto mb-4 w-48 h-48 object-cover rounded-full" />
                ...
                <section className="flex flex-col lg:flex-row items-center justify-between p-8 h-128">
                    ...
                    <div className="lg:w-1/2 flex justify-center items-center">
                        <img src="/images/sdvosb.png" alt="SDVOSB" className="w-auto h-auto max-w-full max-h-[200px]" />
                    </div>
                </section>
