        ...
        <div style={{ paddingTop: '60px' }}>
            ...
            <section class="grid grid-cols-1 md:grid-cols-2 gap-8 p-8">
                <div class="text-center">
                    <img src="/images/associate.jpg" alt="Associate" class="mx-auto mb-4 w-48 h-48 object-cover rounded-full" />
                    <h3 class="text-2xl font-bold">Associate</h3>
                ...
                <div class="text-center">
                    <img src="/images/manager.jpg" alt="Manager" class="mx-auto mb-4 w-48 h-48 object-cover rounded-full" />
                    <h3 class="text-2xl font-bold">Manager</h3>
                    <ul class="list-disc pl-6 space-y-2 text-left">
