        ...
        <div style={{ paddingTop: '60px' }}>
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-8 p-8">
                <div className="text-center">
                    <img src="/images/associate.jpg" alt="Associate" className="mx-auto mb-4 w-48 h-48 object-cover rounded-full" />
                ...
                <div className="text-center">
                    <img src="/images/manager.jpg" alt="Manager" className="mx-auto mb-4 w-48 h-48 object-cover rounded-full" />
